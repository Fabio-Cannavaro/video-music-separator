...
| FFmpeg GPL Essentials 빌드 | `www.gyan.dev` | Gyan 공식 최신 배포본과 버전·체크섬 정보 다운로드 |
...
- FFmpeg 버전: `https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip.ver`
- FFmpeg 체크섬: `https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip.sha256`
