...
class DistributionDocumentTests(unittest.TestCase):
    ...
    def test_readme_documents_supported_environment_and_first_install(self) -> None:
        ...
        processing = lines.index("### 음악·비음악 분리 원리")
        ...
        self.assertLess(usage, install)
        self.assertLess(usage, processing)
        self.assertLess(processing, install)
        ...
        self.assertNotIn("### 앱 처리 흐름", readme)
        self.assertNotIn("### Application Workflow", readme)
